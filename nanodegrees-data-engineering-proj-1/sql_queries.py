...
user_table_insert = ("""
INSERT INTO users AS u  (user_id, first_name, last_name, gender, level) 
                 VALUES (%s, %s, %s, %s, %s)
...
song_select = ("""
SELECT s.song_id, s.artist_id FROM songs as s WHERE s.title = %s AND s.artist_id = %s AND s.duration = %s 
""")
